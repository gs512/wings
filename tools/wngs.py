...
suffix="_ERCC_OUT"
if not ERCC:
	gref="/scratch/gas361/GIA/HSAL/Hsal.v3.3"
	gtf="/scratch/gas361/GIA/HSAL/Hsal.v3.3.gff"
...
for file in my_l:
	...
	if len(my_l[file])==1:
		...
		#file=file[:-12]+suffix
		print(("qsub -N {1} -v OUTPUT={1},FQ1={2},IDX={3},GTF={4},WD={5} ~/scripts/tophat.pbs;").format(jid,file+suffix,fq1,gref,gtf,wd))
		...
		file=file+suffix
		print( ("qsub -N {1} -v OUTPUT={1},FQ1={2},FQ2={3},IDX={4},GTF={5},WD={6} ~/scripts/tophat.pbs;").format(jid,file,fq1,fq2,gref,gtf,wd))
